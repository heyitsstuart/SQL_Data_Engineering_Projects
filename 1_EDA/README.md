...
![Project One Overview](../Images/1_1_Project1_EDA.png)
...
2. [02_top_paying_skills.sql](./02_top_paying_skills.sql) - salary analysis with aggregation  
...
## Analysis Overview
### Query Structure
1. **[Top Demanded Skills](./01_top_demanded_skills.sql01_to)** – Identifies the 10 most in-demand skills for remote data engineer positions  
