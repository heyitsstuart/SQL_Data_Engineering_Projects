...
SELECT
    COUNT(*) AS senior_job_count
FROM senior_jobs_flat_temp;

--Testing the conditions of the tables before DELETE, TRUNCATE, DROP TABLE
...
SELECT COUNT(*) FROM staging.job_postings_flat;
SELECT COUNT(*) FROM staging.priority_jobs_flat_view;  -- Note that the view updates according to the new job_postings_flat table because it was queried from it.
SELECT COUNT(*) FROM senior_jobs_flat_temp;
